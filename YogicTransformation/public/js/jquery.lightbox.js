...
//                    '<a href="#" class="lightbox__close lightbox__button"></a>' +
            ...
            loadImage: function () {
                ...
                $(img).on('load', function () {
                    ...
                    // Preload next image if preload attribute is not set
                    if ($(plugin.preload).attr('href') != null && 
                            $(plugin.preload).attr('preload') == null) {
                        var nextImg = new Image();
                        nextImg.src = $(plugin.preload).attr('href');
                        $(plugin.preload).attr('preload', 'preload');
                    }
                });
            },
